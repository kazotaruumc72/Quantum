...
public class DungeonUtilTabCompleter implements TabCompleter {
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        // Argument 2: Tool types
        if (args.length == 2) {
            if (args[0].equalsIgnoreCase("give")) {
                List<String> toolTypes = Arrays.asList("pickaxe", "pioche", "axe", "hache", "hoe", "houe");
